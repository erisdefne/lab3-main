...
public class Main {
    ...
    private static String promptForCountry(Translator translator) {
        ...
        for (String country : countries) {
            countrynameslist.add(converter.fromCountryCode(country));
        }
        Collections.sort(countrynameslist);
        for (int i = 0; i < countrynameslist.size(); i++) {
            System.out.println(countrynameslist.get(i));
        }
    ...
    private static String promptForLanguage(Translator translator, String country) {
        ...
        for (String language : languages) {
            languagenameslist.add(converter.fromLanguageCode(language));
        }
        Collections.sort(languagenameslist);
        for (int i = 0; i < languagenameslist.size(); i++) {
            System.out.println(languagenameslist.get(i));
        }
